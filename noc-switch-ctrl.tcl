...
check_fsv -fault -remove -node free
check_fsv -fault -remove -node mux_in
check_fsv -fault -remove -node mux_out

check_fsv -fault -remove -node h
check_fsv -fault -remove -node ack_h
check_fsv -fault -remove -node address
...
check_fsv -strobe -add {ack_h free mux_in mux_out} -functional
