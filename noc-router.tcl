...
check_fsv -fault -add [get_design_info -instance RouterCC -list signal -silent] -type SA0+SA1
...
check_fsv -fault -add [get_design_info -instance RouterCC -list flop -silent] -type SEU
check_fsv -fault -add [get_design_info -instance RouterCC -list flop -silent] -type SET
