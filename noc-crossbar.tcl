...
set TOP_MODULE Hermes_crossbar
...
check_fsv -fault -remove -node tab_in
check_fsv -fault -remove -node tab_out
...
check_fsv -strobe -add {data_ack tx data_out} -functional
